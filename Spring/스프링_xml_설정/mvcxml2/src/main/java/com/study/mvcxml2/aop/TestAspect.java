...
public class TestAspect {
	...
	//@Before("target(com.study.mvcxml2.test.TestComponent)") // TestComponent의 모든 메소드에 적용됨
	@Before("execution(public void com.study.mvcxml2.test.TestComponent.run())") //run()메소드에만 시작 전에 적용됨
	public void before() {
		logger.info("================before Aspect 실행=======================================");
		//logger.warn("before Aspect 실행=======================================");
		//logger.error("before Aspect 실행=======================================");
	}
	
	@After("target(com.study.mvcxml2.test.TestComponent)")
	public void after() {
		logger.info("--------------after Aspect 실행---------------------------------");
	}
